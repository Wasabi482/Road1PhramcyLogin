...
<body class="frontpage-background">
    <div class="frontpage-container">
        <nav class="nav-bar navbar navbar-expand-md navbar-dark" style="position:fixed">
            <div class="container-fluid">
                <a class="title" href="index.php">
                    <img src="../Images/IMG_5789__1_-removebg-preview.png" class="logo-image-navbar h1" alt="logo">Road 1 Pharmacy
                </a>
        ...
        <div>
            <a href="ai.php"><img class="chatbot" src="../Images/output-onlinegiftools.gif" alt="" title="Hi"></a>
        </div>
    ...
    <div id="About" class="cont">
                ...
                <div class="aboutus-card">
                    <div class="card-box left">
                        <div class="img-cont">
                            <img class="card-img" src="https://cdn.truyen-hentai.com/nurse-6?interlace=1&quality=85&type=jpeg&url=https%3A%2F%2Fi.redd.it%2Fgaw8f3ig8kja1.jpg&width=400&sign=Fcv3uPittnM3izH0X7WwvO4QF-Z0ObMCHQ2O-HYBFYk" alt="">
                            <a href="#" class="section-button">Go somewhere</a>
                    ...
                    <div class="card-box middle" >
                        <div class="img-cont" >
                            <img class="card-img" src="https://preview.redd.it/hentai-nurse-collection-v0-5rgjtfgtou5a1.jpg?width=504&format=pjpg&auto=webp&s=1f72fe1b8c9e91e0a95caff2bbbd02e78fc0d0ae" alt="">
                            <a href="#" class="section-button">Go somewhere</a>
                    ...
                    <div class="card-box right">
                        <div class="img-cont">
                            <img class="card-img" src="https://us.rule34.xxx//images/7081/3fb040962a404b293df4c1a3605b464f.png?8076943" alt="">
                            <a href="#" class="section-button">Go somewhere</a>
