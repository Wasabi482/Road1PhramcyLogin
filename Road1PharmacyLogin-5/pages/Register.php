   ...
   <div class="section ">
      <div class="container ">
         ...
         <a href="Login.php" class="return"><img width="50" height="50" src="https://img.icons8.com/ios/50/FFFFFF/circled-left--v1.png" alt="circled-left--v1"/></a>
            <div class="logo">
               <img class="logo-image" src="../Images/IMG_5789__1_-removebg-preview.png" alt="logo">
         ...
         <div class="form-section bg-dark" >
            <form  method="post" action="../actions/register.php">
               ...
               <div class="input-form">
                  ...
                  <label class="hidden-label" for="username">Password</label>
               </div>
               <div class="input-form">
                  <input type="password" class="input bg-dark"  name="cpassword" required placeholder="Confirm Password">
                  <label class="hidden-label" for="username">Confirm Password</label>
               </div>
               <div class="input-form">
                  <input type="email" class="input bg-dark"  name="email" required placeholder="Enter your email">
                  <label class="hidden-label" for="username">Email</label>
               </div>
               <div class="input-form">
                  <input type="file" id="myFile" name="picture">
                  <label class="pic-label" for="filename">Profile Picture</label>
               </div>
               <div class="input-form">
                  <select name="role_as" id="role" class="input bg-dark">
